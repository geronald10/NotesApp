package goronald.web.id.mynotesapp.provider;
...
import goronald.web.id.mynotesapp.db.DatabaseContract;
import goronald.web.id.mynotesapp.db.NoteHelper;

import static goronald.web.id.mynotesapp.db.DatabaseContract.AUTHORITY;
...
public class NoteProvider extends ContentProvider {
    ...
    static {
        // content://goronald.web.id.mynotesapp/note
        sUriMatcher.addURI(AUTHORITY, DatabaseContract.TABLE_NOTE, NOTE);
        // content://goronald.web.id.mynotesapp/note/id
